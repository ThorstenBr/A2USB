;          APPLEMOUSE II CLAMP TEST PROGRAM
...
;   Call CLAMPMOUSE to clamp X values
           LDY #CLAMPMOUSE ;Pick up offset to offset
           LDA #$11        ;Low byte of lower boundary
           STA $0478
           LDA #$01        ;high byte of lower boundary
           STA $0578
           LDA #$22        ;low byte of higher boundary
           STA $04f8
           LDA #$02        ;high byte of higher boundary
           STA $05f8
           LDA #$00        ;select X boundaries
           JSR CALLCARD
           
;   Call CLAMPMOUSE to clamp Y values
           LDA $05f8
           PHA
           LDY #CLAMPMOUSE ;Pick up offset to offset
           LDA #$33        ;Low byte of lower boundary
           STA $0478
           LDA #$03        ;high byte of lower boundary
           STA $0578
           LDA #$44        ;low byte of higher boundary
           STA $04f8
           LDA #$04        ;high byte of higher boundary
           STA $05f8
           LDA #$01        ;select Y boundaries
           JSR CALLCARD
           PLA
           STA $05f8
